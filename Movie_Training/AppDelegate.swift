...
//            UNUserNotificationCenter.current().setNotificationCategories(Set([deafultCategory]))
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Movie_Training")
...
extension AppDelegate : UNUserNotificationCenterDelegate {
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        // prevents push if user is in Chat screen view
        // code here
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        //when notify displayed on device, user touchs into notification view it will take user to chat screen view
        //code here
        let rootViewController = self.window?.rootViewController as! UINavigationController
        let storyboard = UIStoryboard.init(name: "Chat", bundle: nil)
        let chatSV = storyboard.instantiateViewController(withIdentifier: "ChatView") as! ChatViewController
        rootViewController.pushViewController(chatSV, animated: true)
